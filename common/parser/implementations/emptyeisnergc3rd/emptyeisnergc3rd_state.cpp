...
namespace emptyeisnergc3rd {
	...
	void StateItem::updateL2REmptyInside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
		l2r_empty_inside[grand].insertItem(ScoreWithBiSplit(split, innersplit, score));
	}

	void StateItem::updateR2LEmptyInside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
		r2l_empty_inside[grand].insertItem(ScoreWithBiSplit(split, innersplit, score));
	}

	void StateItem::updateL2RSolidOutside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
		l2r_solid_outside[grand].insertItem(ScoreWithBiSplit(split, innersplit, score));
	}

	void StateItem::updateR2LSolidOutside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
		r2l_solid_outside[grand].insertItem(ScoreWithBiSplit(split, innersplit, score));
	}

	void StateItem::updateL2REmptyOutside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
		l2r_empty_outside[grand].insertItem(ScoreWithBiSplit(split, innersplit, score));
	}

	void StateItem::updateR2LEmptyOutside(const int & grand, const int & split, const int & innersplit, const tscore & score) {
