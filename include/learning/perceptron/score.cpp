...
ScoreWithBiSplit::ScoreWithBiSplit(const int &sp, const int &isp, const tscore &sc) : m_nSplit(sp), m_nInnerSplit(isp),
                                                                                      m_nScore(sc) { }

ScoreWithBiSplit::ScoreWithBiSplit(const ScoreWithBiSplit &swbs) : ScoreWithBiSplit(swbs.m_nSplit, swbs.m_nInnerSplit,
                                                                                    swbs.m_nScore) { }
