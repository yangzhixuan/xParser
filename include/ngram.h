...
public:
    TriGram(const TriGram<KEY_TYPE> &trigram) : gram1(trigram.gram1), gram2(trigram.gram2), gram3(trigram.gram3),
                                                m_nHash(trigram.m_nHash) { }

    TriGram(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0) : gram1(_gram1), gram2(_gram2),
                                                                             gram3(_gram3) {
        computeHash();
    }
...
public:
    QuarGram(const QuarGram<KEY_TYPE> &quargram) : gram1(quargram.gram1), gram2(quargram.gram2), gram3(quargram.gram3),
                                                   gram4(quargram.gram4), m_nHash(quargram.m_nHash) { }

    QuarGram(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0, KEY_TYPE _gram4 = 0) : gram1(_gram1),
                                                                                                   gram2(_gram2),
                                                                                                   gram3(_gram3),
                                                                                                   gram4(_gram4) {
        computeHash();
...
public:
    QuinGram(const QuinGram<KEY_TYPE> &quingram) : gram1(quingram.gram1), gram2(quingram.gram2), gram3(quingram.gram3),
                                                   gram4(quingram.gram4), gram5(quingram.gram5),
                                                   m_nHash(quingram.m_nHash) { }

    QuinGram(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0, KEY_TYPE _gram4 = 0, KEY_TYPE _gram5 = 0)
            : gram1(_gram1), gram2(_gram2), gram3(_gram3), gram4(_gram4), gram5(_gram5) {
        computeHash();
    }
    ...
    friend std::ostream &operator<<(std::ostream &os, const QuinGram<KEY_TYPE> &quingram) {
        os << "[ " << quingram.gram1 << " " << quingram.gram2 << " " << quingram.gram3 << " " << quingram.gram4 <<
        " " << quingram.gram5 << " ]";
        return os;
    }
    ...
    friend bool operator==(const QuinGram<KEY_TYPE> g1, const QuinGram<KEY_TYPE> g2) {
        return g1.m_nHash == g2.m_nHash && g1.gram1 == g2.gram1 && g1.gram2 == g2.gram2 && g1.gram3 == g2.gram3 &&
               g1.gram4 == g2.gram4 && g1.gram5 == g2.gram5;
    }
};
...
public:
    HexaGram(const HexaGram<KEY_TYPE> &hexagram) : gram1(hexagram.gram1), gram2(hexagram.gram2), gram3(hexagram.gram3),
                                                   gram4(hexagram.gram4), gram5(hexagram.gram5), gram6(hexagram.gram6),
                                                   m_nHash(hexagram.m_nHash) { }

    HexaGram(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0, KEY_TYPE _gram4 = 0, KEY_TYPE _gram5 = 0,
             KEY_TYPE _gram6 = 0) : gram1(_gram1), gram2(_gram2), gram3(_gram3), gram4(_gram4), gram5(_gram5),
                                    gram6(_gram6) {
        computeHash();
    }
    ...
    friend std::istream &operator>>(std::istream &is, HexaGram<KEY_TYPE> &hexagram) {
        ttoken token;
        is >> token >> hexagram.gram1 >> hexagram.gram2 >> hexagram.gram3 >> hexagram.gram4 >> hexagram.gram5 >>
        hexagram.gram6 >> token;
        hexagram.computeHash();
        return is;
    }

    friend std::ostream &operator<<(std::ostream &os, const HexaGram<KEY_TYPE> &hexagram) {
        os << "[ " << hexagram.gram1 << " " << hexagram.gram2 << " " << hexagram.gram3 << " " << hexagram.gram4 <<
        " " << hexagram.gram5 << " " << hexagram.gram6 << " ]";
        return os;
    }

    friend bool operator==(const HexaGram<KEY_TYPE> g1, const HexaGram<KEY_TYPE> g2) {
        return g1.m_nHash == g2.m_nHash && g1.gram1 == g2.gram1 && g1.gram2 == g2.gram2 && g1.gram3 == g2.gram3 &&
               g1.gram4 == g2.gram4 && g1.gram5 == g2.gram5 && g1.gram6 == g2.gram6;
    }
};
...
public:
    SeptGram(const SeptGram<KEY_TYPE> &septgram) : gram1(septgram.gram1), gram2(septgram.gram2), gram3(septgram.gram3),
                                                   gram4(septgram.gram4), gram5(septgram.gram5), gram6(septgram.gram6),
                                                   gram7(septgram.gram7), m_nHash(septgram.m_nHash) { }

    SeptGram(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0, KEY_TYPE _gram4 = 0, KEY_TYPE _gram5 = 0,
             KEY_TYPE _gram6 = 0, KEY_TYPE _gram7 = 0) : gram1(_gram1), gram2(_gram2), gram3(_gram3), gram4(_gram4),
                                                         gram5(_gram5), gram6(_gram6), gram7(_gram7) {
        computeHash();
    }
    ...
    void refer(KEY_TYPE _gram1 = 0, KEY_TYPE _gram2 = 0, KEY_TYPE _gram3 = 0, KEY_TYPE _gram4 = 0, KEY_TYPE _gram5 = 0,
               KEY_TYPE _gram6 = 0, KEY_TYPE _gram7 = 0) {
        gram1 = _gram1;
        gram2 = _gram2;
        gram3 = _gram3;
        gram4 = _gram4;
    ...
    friend std::istream &operator>>(std::istream &is, SeptGram<KEY_TYPE> &septgram) {
        ttoken token;
        is >> token >> septgram.gram1 >> septgram.gram2 >> septgram.gram3 >> septgram.gram4 >> septgram.gram5 >>
        septgram.gram6 >> septgram.gram7 >> token;
        septgram.computeHash();
        return is;
    }

    friend std::ostream &operator<<(std::ostream &os, const SeptGram<KEY_TYPE> &septgram) {
        os << "[ " << septgram.gram1 << " " << septgram.gram2 << " " << septgram.gram3 << " " << septgram.gram4 <<
        " " << septgram.gram5 << " " << septgram.gram6 << " " << septgram.gram7 << " ]";
        return os;
    }

    friend bool operator==(const SeptGram<KEY_TYPE> g1, const SeptGram<KEY_TYPE> g2) {
        return g1.m_nHash == g2.m_nHash && g1.gram1 == g2.gram1 && g1.gram2 == g2.gram2 && g1.gram3 == g2.gram3 &&
               g1.gram4 == g2.gram4 && g1.gram5 == g2.gram5 && g1.gram6 == g2.gram6 && g1.gram7 == g2.gram7;
    }
};
